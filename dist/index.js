...
var fs = Utils.FileSystem.require(),
	pth = __nccwpck_require__(6928);

fs.existsSync = fs.existsSync || pth.existsSync;

var ZipEntry = __nccwpck_require__(2609),
	ZipFile = __nccwpck_require__(6991);
...
var fs = (__nccwpck_require__(7952).require)(),
    pth = __nccwpck_require__(6928);
...
exports.require = function() {
  ...
  if (process.versions['electron']) {
	  try {
	    originalFs = __nccwpck_require__(4320);
...
module.exports.FileSystem = __nccwpck_require__(7952);
...
module.exports = (function() {
    ...
    var crcTable = [],
        Constants = __nccwpck_require__(2834),
        Errors = __nccwpck_require__(6232),
...
var ZipEntry = __nccwpck_require__(2609),
	Headers = __nccwpck_require__(1907),
	Utils = __nccwpck_require__(5391);
